...
#include <memory>
#include "../../../../../../../src/apps/Viewer2d/drawwidget.h"
...
QT_MOC_LITERAL(1, 11, 13), // "pointsChanged"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 16), // "QVector<QPointF>"
QT_MOC_LITERAL(4, 43, 6), // "points"
QT_MOC_LITERAL(5, 50, 4), // "sign"
QT_MOC_LITERAL(6, 55, 1) // "t"

    },
    "DrawWidget\0pointsChanged\0\0QVector<QPointF>\0"
    "points\0sign\0t"
};
...
void DrawWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->pointsChanged((*reinterpret_cast< const QVector<QPointF>(*)>(_a[1]))); break;
        ...
        {
            using _t = void (DrawWidget::*)(const QVector<QPointF> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawWidget::pointsChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DrawWidget::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DrawWidget::sign)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void DrawWidget::pointsChanged(const QVector<QPointF> & _t1)
{
